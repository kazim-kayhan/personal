...
export function Do({ children = null }: PropsWithChildren) {
  return (
    <div className={cn("mdx-do", "md:min-w-0 md:flex-1")}>
      <div
        className={cn(
      ...
      >
        <div className={cn("")}>
          <CheckCircleIcon
            className={cn("h-5 w-5 text-green-600", "dark:text-green-300")}
          />
          <div
            className={cn(
...
export function Dont({ children = null }: PropsWithChildren) {
  return (
    <div className={cn("mdx-dont", "md:min-w-0 md:flex-1")}>
      <div
        className={cn(
          "relative flex items-start gap-2 pb-2 text-sm font-semibold text-slate-700",
          "dark:text-slate-300",
      ...
      >
        <div className={cn("")}>
          <XCircleIcon
            className={cn("h-5 w-5 text-red-600", "dark:text-red-300")}
          />
          <div
            className={cn(
...
export function ItemTags({ children = null }: PropsWithChildren) {
  return <div className={cn("-mt-1 mb-4 flex gap-2")}>{children}</div>;
}
...
export function Items({ date, children }: PropsWithChildren<ItemsProps>) {
  return (
    <div className={cn("flex flex-row gap-6", "md:gap-12 lg:gap-24")}>
