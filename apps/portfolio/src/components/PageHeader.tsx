...
function PageHeader({
  ...
  return (
    ...
    >
      {headerImage && (
        <div className={mc("content-wrapper absolute inset-0 overflow-hidden")}>
          <div
            className={mc(
          ...
          >
            <div className={mc("content-wrapper relative h-full")}>
              <div className={mc("absolute right-0 -top-24 bottom-0")}>
                {headerImage}
              </div>
            </div>
          </div>
